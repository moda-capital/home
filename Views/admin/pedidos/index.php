    ...
    <div class="tab-content" id="myTabContent">
            ...
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover align-middle" style="width: 100%; text-align: center;" id="tblPendientes">
                            <thead>
                                <tr>
        ...
        <div class="tab-pane fade" id="listaProceso" role="tabpanel" aria-labelledby="proceso-tab">
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover align-middle" style="width: 100%; text-align: center;" id="tblProceso">
                            <thead>
                                <tr>
                                    <th>Id_Transacción</th>
                                    <th>Monto</th>
        ...
        <div class="tab-pane fade" id="pedidosfinalizados" role="tabpanel" aria-labelledby="profile-tab">
            <div class="card" style="width: 100%;">
                <div class="card-body">
                <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover align-middle" style="width: 100%; text-align: center;" id="tblFinalizados">
                            <thead>
                                <tr>
                                    <th>Id_Transacción</th>
                                    <th>Monto</th>
