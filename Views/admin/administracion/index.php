        ...
        <div class="card radius-10 border-start border-0 border-3 border-success">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="widgets-icons-2 rounded-circle bg-gradient-ohhappiness text-white ms-auto"><i class='fas fa-check '></i>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-10">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Proceso <span class="badge bg-danger rounded-pill"><?php echo $data['procesos']['total']; ?> </span>
                </li>
                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Pendientes <span class="badge bg-primary rounded-pill"><?php echo $data['pendientes']['total']; ?> </span>
                </li>
        ...
        <div class="card radius-10 w-100">
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center">
                    <div>
                        <h6 class="mb-0">Productos Con Poca Cantidad</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-10 w-100">
            ...
            <div class="card-body">
                <div class="chart-container-1">
                    <canvas id="mejoresProductos"></canvas>
                </div>
            </div>
        </div>
    </div>
