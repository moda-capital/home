            ...
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover align-middle" style="width: 100%; text-align: center;" id="tblProductos">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nombre</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo BASE_URL . 'productos/galeriaImagenes'; ?>" class="dropzone" >
                        <div class="dz-default dz-message"><button class="dz-button" type="button">Arrastra y Suelta las Imagenes</button></div>
